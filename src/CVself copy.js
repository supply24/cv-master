                ...
                <Col className='bodyfemale' style={{ width: '100%', marginLeft: -0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Col style={{ marginLeft: -25 }}>
                        <Card style={{ align: "right", width: 600, height: 1600, borderRight: 'none', borderTop: 'none', borderBottom: 'none', boxShadow: 'none' }}>
                            ...
                            <Row>
                                <Col align="left" style={{ marginLeft: 20, marginRight: 100, marginTop: 20, fontSize: 12, color: 'black' }}><b>Utbildning</b>
                                    <br></br>      <textarea style={{ resize: "none", width: 300, border: "none", outline: "none", marginLeft: 0, marginRight: 20, rows: 15, backgroundColor: "none" }} placeholder='Skriv Utbildning' />
                                </Col>
                            </Row>
                            <Row>
                                <Col align="left" style={{ marginLeft: 20, marginRight: 100, marginTop: 20, fontSize: 12, color: 'black' }}><b>Erfarenhet</b>
                                    <br></br>      <textarea style={{ width: 300, border: "none", marginLeft: 0, rows: 3, backgroundColor: "none" }} placeholder='Skriv Erfarenhet' />
                                </Col>
                            </Row>

                            <Row>
                                <Col align="left" style={{ marginLeft: 20, marginRight: 20, marginTop: 20, fontSize: 12, color: 'black' }}><b>Övrig erfarenhet
                                </b>
                                    <br></br>      <textarea style={{ width: 300, border: "none", marginLeft: 0, rows: 3, backgroundColor: "none" }} placeholder='Skriv Övrig erfarenhet' />
                                </Col>
                            </Row>
